...
@section('content')
    <table class="table table-hover table-striped">
        <tr>
            ...
            <th width="180" style="text-align: center;">发表时间</th>
            ...
            <tr>
                ...
                <td style="text-align: center;">
                    <span class="label label-info"
                          style="width: 80px;display: inline-block;">{{ $post->category->name }}</span>
                </td>
                <td style="text-align: center;">{{ $post->created_at }}</td>
                <td style="text-align: center;">
                    <div class="btn-group btn-group-sm" role="group">
                        <button type="button" class="btn btn-info">
                            <span class="glyphicon glyphicon-info-sign" id="check"></span> 查看
                        </button>
